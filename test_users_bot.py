...
TOKEN = '5601547932:AAEEHJMxTDg3mmgmjt-Vcc0lIbSskfsLtPk'
...
def start_message_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text="Привет!\nЭтот бот сгенерирует для тебя данные тестовых пользователей. "\
        "Сколько пользователей тебе требуется?",
...
def message_handler(message: types.Message):
    ...
    bot.send_message(
        chat_id=message.chat.id,
        text="Если потребуется ещё, снова нажми кнопку снизу",
        reply_markup=main_menu_reply_markup
    )
